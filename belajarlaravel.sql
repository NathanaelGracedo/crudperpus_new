...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Sep 2021 pada 06.25
...
(1, 'Doujin', 'Mad Loki', 'Nekopoi', 'Menceritakan petualangan pemuda yang terdampar di dunia lain dengan melewati berbagai rintangan', 'http://localhost/perpustakaan/assets/foto_produk/oredake.jpg'),
(2, 'Tate no Yushaa', 'Mad Loki', 'Bunny Walker', 'Bercerita tentang seorang otaku rumahan bernama Naofumi Iwatani yang telah dipanggil ke dunia isekai dan terpilih menjadi salah satu dari empat ksatria yang harus melindungi kerajaan Melromarc.', 'http://localhost/perpustakaan/assets/foto_produk/tate.jpg');
...
(5, 2, '2021-09-29', '2021-10-04'),
(6, 2, '2021-09-29', '2021-10-04');
...
(2, 'Nathanael Juan Gracedo', '2021-09-29', 'L', 'Kediri', 'Nathan', '202cb962ac59075b964b07152d234b70', 1);
